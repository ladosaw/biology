    ...
    <div className="px-4 lg:px-4 text-justify text-sm sm:text-base md:text-lg">
      ...
      <div>
        ...
        <div className="flex flex-col justify-center items-center mt-8z gap-8 my-8">
          ...
          <div className="w-full sm:w-3/4 md:w-2/3 lg:w-3/4 xl:w-2/3 aspect-video rounded-lg overflow-hidden shadow-lg mb-10">
            <iframe
              className="w-full h-full"
              src="https://www.youtube.com/embed/-PfVNZedmGA?si=EnYhqLxcvoSvrMNR"
              title="Mitosis"
      ...
      {!hideAdditionalButtons && (
        <div className="flex flex-col items-end mt-10 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center w-full gap-4 sm:gap-8 mt-8">
            <BtnNextPrev
              name="Lesson 1: Digestive System"
