  ...
  return (
    <div className="px-4 lg:px-4">
      ...
      <div className="flex flex-col gap-8">
        ...
        <p className="text-sm sm:text-base md:text-lg leading-relaxed">
          <span className="font-semibold">Crossing over</span> - the exchange of
          genetic materials that produce a combination of genes along
      ...
      <div className="flex flex-col justify-center items-center mt-8 gap-8">
        ...
        <p className="text-sm sm:text-base md:text-lg text-center mt-4">
          <span className="block">
            <span className="font-semibold">Figure 2</span>:  Figure 2 : Human
        ...
        <div className="bg-white py-8 px-8 rounded-lg shadow-lg space-y-6">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              eukaryotic organisms: somatic, or body cells, and gametes, or sex
              cells. The majority of the cells are called somatic or body cells.
              These consist of two complete sets of chromosomes, making them
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              Diploid means the nucleus of the nucleus of our body contains two
              sets of homologous chromosomes. We inherited half of these
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              autosomes and one pair of sex chromosomes, which either be X or Y.
              Therefore, our gametes are haploid cells (N) since they carry a
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              suggests that different kinds of cell division must take place in
              an individual. This kind of cell division is called meiosis, from
              the Greek word that means “to make smaller”, Meiosis reduces the
              chromosomes number in half. It is a form of sexual reproduction
              that takes place in the ovaries (egg cell) and testes (sperm
              cell)  of animals during the formation of gametogenesis
              (spermatogenesis and oogenesis). Meiosis is a special type of cell
              division where the cell undergoes two cellular divisions: Meiosis
              1 and Meiosis II.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white py-8 px-8 rounded-lg shadow-lg space-y-6">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              stages, namely, prophase I, metaphase I, anaphase I, and telophase
              I. Another important event is{" "}
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              the occurrence of crossingover and different substages of prophase
              I respectively.
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              <span className="font-semibold">Leptotene</span> - Each chromosome
              is made up of two long threads of sister chromatids because of
              replication during the S phase of the cell cycle.
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              <span className="font-semibold">Zygotene</span> - The chromosomes
              begin to pair off. Pairs of chromosomes are called homologous
              chromosomes, and this pairing process is exact
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              <span className="font-semibold">Pachytene</span> - The chromosomes
              contract due to repeated coiling. Crossing-over takes place where
              a segment of the sister chromatid of one of the chromosomes is
              exchanged with the same segment of the sister chromatid of the
              homologous chromosomes through the formation of a cross-linked of
              the segments called chiasma. After crossing over, the sister
              chromatids of each chromosome may no longer be identical to each
              other based on the genetic material they contain
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
        ...
        <div className="bg-white py-8 px-8 rounded-lg shadow-lg space-y-6">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              <span className="font-semibold">Anaphase 1</span> - Spindle fibers
              form and attach to the centromeres of the chromosomes. The
              homologous chromosomes separate from each other completely and
              start their movement towards the poles of the cells as they pulled
              by the spindle fibers. As the centromere of each other chromosomes
              do not divide, the sister chromatids remain together.
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              <span className="font-semibold">Telophase 1</span> - In this stage
              the chromosomes reach their respective poles. Cytokinesis follows
              and two daughter cells are formed. Each cell now has half the
              chromosome number because only one chromosome from each other pair
              goes to the daughter cell. This is called the haploid condition.
              In difference to the diploid condition at the beginning of the
              meiosis I where each chromosome pair is intact. Telophase comes
              after by interphase II.
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              Take note that each chromosome still has two sister chromatids; it
              is therefore required for the cells to undergo another round of
              division.
            </p>
          </div>
          <div className="flex flex-wrap md:flex-nowrap gap-6">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              ...
              outcome is four cells, two from each daughter cell from meiosis I,
              with one-half the diploid chromosome number and wait only one
              ...
              four haploid (n) daughter cells are formed. Each cell is carrying
            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border border-gray-300 p-2">Somatic cells</td>
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-300 p-2">
                    ...
                    <p>
                      ...
                      number of somatic cells, which is important for the growth
                      of organisms.
                    </p>
                  </td>
                  <td className="border border-gray-300 p-2">
                ...
                <tr>
                  <td className="border border-gray-300 p-2">
                    ...
                    <p>
                      During mitosis, the resulting two daughter cells have the
                      same type and number of genes as the original parent cell,
                      preserving genetic composition.
                    </p>
                  </td>
                  <td className="border border-gray-300 p-2">
                    ...
                    <p>
                      ...
                      of the parent cell. These gametes combine during
                      fertilization, resulting in offspring with varied DNA
                      sequences.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">
                    <strong>4. For the repair of damaged cells/tissues</strong>
                    <p>
                      Mitosis helps repair worn-out body cells and replaces
                      damaged cells and tissues through repeated cell division.
                    </p>
                  </td>
                  <td className="border border-gray-300 p-2">
